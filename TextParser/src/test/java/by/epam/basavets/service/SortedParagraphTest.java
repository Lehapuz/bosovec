...
public class SortedParagraphTest extends TestCase {
    ...
    public void testGetSortedParagraph() throws IOException {
        ...
        text.getChildrenList().forEach(paragraph -> expected.append(paragraph.getParagraph().trim() + "\n"));
        textService.getSortedParagraph(PATH_FILE).forEach(paragraph -> actual.append(paragraph.getParagraph().trim() + "\n"));
